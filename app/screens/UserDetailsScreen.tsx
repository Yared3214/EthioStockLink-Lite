  ...
  const UserDetailsScreen = () => {
    ...
    const onSubmit = async () => {
      ...
      if (!name || !email || !password) {
        Alert.alert("Validation Error", "You have to fill all the informations in the previous page");
        return;
      }
      ...
      if (!experience) {
        Alert.alert("Validation Error", "Please select your investment experience level.");
        return;
      }
      ...
      try {
        ...
        Alert.alert("Network Error", "Error submitting data.");
        console.error(err);
      }
    };        
